...
module.exports = async (req, res) => {
    ...
    try {
        ...
        const messages = [
            { role: 'system', content: `You are the AI Assistant — a friendly and helpful virtual assistant representing AI, a company that offers AI consulting and implementation services.
